          ...
          <div className="problem-split-grid">
            ...
            <div className="problem-split-right">
              <svg viewBox="0 0 400 330" width="100%" height="100%" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* ACTIVE CONNECTIONS: 3D PATH RUNS (DARK BASES) */}
                <path d="M205,84 L205,100 L185,111.6 L185,145" stroke="#1A1C1E" strokeWidth="1.2" strokeLinecap="round" style={{ transition: 'opacity 0.3s', opacity: hoveredNode && hoveredNode !== 'access' && hoveredNode !== 'core' ? 0.2 : 1 }} />
                <path d="M270,124 L270,140 L200,180.4 L200,150" stroke="#1A1C1E" strokeWidth="1.2" strokeLinecap="round" style={{ transition: 'opacity 0.3s', opacity: hoveredNode && hoveredNode !== 'video' && hoveredNode !== 'core' ? 0.2 : 1 }} />
                <path d="M335,164 L335,180 L215,249.2 L215,150" stroke="#1A1C1E" strokeWidth="1.2" strokeLinecap="round" style={{ transition: 'opacity 0.3s', opacity: hoveredNode && hoveredNode !== 'threat' && hoveredNode !== 'core' ? 0.2 : 1 }} />
                ...
                <polygon points="185,210 145,187 145,191 185,214" fill="#0D0D12" stroke="#1A1C1E" strokeWidth="0.5" />
                <polygon points="185,210 185,214 225,191 225,187" fill="#08080C" stroke="#1A1C1E" strokeWidth="0.5" />

                {/* Middle Slab */}
                <polygon points="185,187 150,167 185,147 220,167" fill="rgba(22, 22, 32, 0.9)" stroke="rgba(139, 143, 255, 0.15)" strokeWidth="0.8" />
                <polygon points="185,187 150,167 150,171 185,191" fill="#0F0F16" stroke="#1A1C1E" strokeWidth="0.5" />
                <polygon points="185,187 185,191 220,171 220,167" fill="#0A0A0F" stroke="#1A1C1E" strokeWidth="0.5" />
                ...
                >
                  ...
                  {/* Left Face */}
                  <polygon points="185,165 155,147 155,151 185,169" fill="#14141F" stroke="#1A1C1E" strokeWidth="0.5" />
                  {/* Right Face */}
                  <polygon points="185,165 185,169 215,151 215,147" fill="#0E0E16" stroke="#1A1C1E" strokeWidth="0.5" />
                ...
                >
                  ...
                  <g transform="matrix(0.866, 0.5, -0.866, 0.5, 60, 228)">
                    <rect x="-40" y="-12" width="80" height="24" rx="4" fill="#08080C" stroke="#1A1C1E" strokeWidth="1" />
                  </g>
                  {/* Top Face */}
                  <g transform="matrix(0.866, 0.5, -0.866, 0.5, 60, 225)">
                    <rect x="-40" y="-12" width="80" height="24" rx="4" fill="rgba(16, 16, 24, 0.95)" stroke="#1A1C1E" strokeWidth="0.8" />
                    <line x1="-39" y1="-12" x2="-39" y2="12" stroke="#ef4444" strokeWidth="2.5" strokeLinecap="round" />
                    <path d="M-28,-3 L-23,-3 L-23,4 L-28,4 Z M-25.5,-3 L-25.5,-6 M-24.5,-1 L-24.5,1" stroke="#1A1C1E" strokeWidth="0.8" fill="none" />
                ...
                >
                  ...
                  <g transform="matrix(0.866, 0.5, -0.866, 0.5, 125, 255)">
                    <rect x="-40" y="-12" width="80" height="24" rx="4" fill="rgba(16, 16, 24, 0.95)" stroke="#1A1C1E" strokeWidth="0.8" />
                    <line x1="-39" y1="-12" x2="-39" y2="12" stroke="#ef4444" strokeWidth="2.5" strokeLinecap="round" />
                    <path d="M-28,-3 L-23,-3 L-23,4 L-28,4 Z M-26,0 L-25,0 M-26,2 L-25,2" stroke="#1A1C1E" strokeWidth="0.8" fill="none" />
                ...
                >
                  ...
                  <g transform="matrix(0.866, 0.5, -0.866, 0.5, 190, 285)">
                    <rect x="-40" y="-12" width="80" height="24" rx="4" fill="rgba(16, 16, 24, 0.95)" stroke="#1A1C1E" strokeWidth="0.8" />
                    <line x1="-39" y1="-12" x2="-39" y2="12" stroke="#ef4444" strokeWidth="2.5" strokeLinecap="round" />
                    <path d="M-28,-2 L-23,-2 L-23,4 L-28,4 Z M-26.5,-2 L-26.5,-4 L-24.5,-4 L-24.5,-2" stroke="#1A1C1E" strokeWidth="0.8" fill="none" />
            ...
            <div className="feature-col-item">
              ...
              <div className="fig-svg-wrap">
                <svg viewBox="0 0 200 160" width="100%" height="160" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  `}</style>
                  <path d="M100,20 L100,140" stroke="#1A1C1E" stroke-dasharray="2,2" />
                  ...
                  <g transform="translate(100, 80)">
                    ...
                    <polygon points="-30,10 30,10 40,25 -40,25" fill="rgba(255,255,255,0.02)" stroke="#1A1C1E" strokeWidth="1" />

                    <line x1="0" y1="10" x2="0" y2="-15" stroke="#1A1C1E" strokeWidth="1.5" />

                    <polygon points="-16,-35 16,-35 16,-15 -16,-15" fill="rgba(0,0,0,0.4)" stroke="#1A1C1E" strokeWidth="1" />
                    ...
                    <line x1="-35" y1="0" x2="35" y2="0" stroke="#1A1C1E" strokeWidth="1.5" strokeDasharray="3,3" style={{ animation: 'line-draw-comm-1 2s linear infinite' }} />
                  </g>
                </svg>
              </div>
              ...
              <div className="fig-svg-wrap">
                <svg viewBox="0 0 200 160" width="100%" height="160" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <g transform="translate(100, 80)">
                    ...
                    <polygon points="-8,25 8,25 2,-20 -2,-20" fill="rgba(255, 255, 255, 0.02)" stroke="#1A1C1E" strokeWidth="1" />
                    <line x1="-5" y1="10" x2="5" y2="10" stroke="#1A1C1E" />
                    <line x1="-3" y1="-5" x2="3" y2="-5" stroke="#1A1C1E" />

                    <circle cx="0" cy="-22" r="3" fill="#8B8FFF" style={{ animation: 'tower-signal-comm-2 1s infinite alternate' }} />

                    <path d="M-40,25 L-20,15 L0,20 L20,15 L40,25" stroke="#1A1C1E" strokeWidth="1" strokeDasharray="2,2" style={{ animation: 'static-noise-comm-2 0.5s infinite linear' }} />
                  </g>
                </svg>
              </div>
            ...
            <div className="feature-col-item">
              ...
              <div className="fig-svg-wrap">
                <svg viewBox="0 0 200 160" width="100%" height="160" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <g transform="translate(100, 80)">
                    <polygon points="0,-40 24,-30 0,-18 -24,-30" stroke="#1A1C1E" strokeWidth="1.5" fill="rgba(255,255,255,0.02)" />
                    <polygon points="0,40 24,30 0,18 -24,30" stroke="#1A1C1E" strokeWidth="1.5" fill="rgba(255,255,255,0.02)" />

                    <line x1="-24" y1="-30" x2="-24" y2="30" stroke="#1A1C1E" strokeWidth="1" />
                    <line x1="24" y1="-30" x2="24" y2="30" stroke="#1A1C1E" strokeWidth="1" />
                    <line x1="0" y1="-18" x2="0" y2="18" stroke="#1A1C1E" strokeWidth="0.8" strokeDasharray="2,2" />

                    <path d="M-20,-28 C-20,-12 -5,-4 -5,0 C-5,4 -20,12 -20,28 L20,28 C20,12 5,4 5,0 C5,-4 20,-12 20,-28 Z" stroke="#1A1C1E" strokeWidth="1" />
                    ...
                    <polygon points="0,26 12,20 0,14 -12,20" stroke="#1A1C1E" strokeWidth="0.8" fill="rgba(255,255,255,0.08)" />
                    <polygon points="0,26 8,22 0,18 -8,22" stroke="#1A1C1E" strokeWidth="0.8" fill="rgba(255,255,255,0.15)" />
                ...
                <svg viewBox="0 0 200 160" width="100%" height="160" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <g transform="translate(100, 80)">
                    <g style={{ animation: 'nodeglow-comm-4 3s infinite alternate' }}>
                      <rect x="-40" y="-35" width="24" height="14" rx="0" fill="rgba(255,255,255,0.02)" stroke="#1A1C1E" strokeWidth="1" />
                      <text x="-28" y="-25" fontFamily="monospace" fontSize="6" fill="rgba(255,255,255,0.4)" textAnchor="middle">TEAM</text>

                      <rect x="16" y="-35" width="24" height="14" rx="0" fill="rgba(255,255,255,0.02)" stroke="#1A1C1E" strokeWidth="1" />
                      <text x="28" y="-25" fontFamily="monospace" fontSize="6" fill="rgba(255,255,255,0.4)" textAnchor="middle">SMS</text>

                      <rect x="-55" y="-5" width="24" height="14" rx="0" fill="rgba(255,255,255,0.02)" stroke="#1A1C1E" strokeWidth="1" />
                      <text x="-43" y="5" fontFamily="monospace" fontSize="6" fill="rgba(255,255,255,0.4)" textAnchor="middle">RAD</text>

                      <rect x="31" y="-5" width="24" height="14" rx="0" fill="rgba(255,255,255,0.02)" stroke="#1A1C1E" strokeWidth="1" />
                      <text x="43" y="5" fontFamily="monospace" fontSize="6" fill="rgba(255,255,255,0.4)" textAnchor="middle">VMS</text>

                      <rect x="-40" y="25" width="24" height="14" rx="0" fill="rgba(255,255,255,0.02)" stroke="#1A1C1E" strokeWidth="1" />
                      <text x="-28" y="35" fontFamily="monospace" fontSize="6" fill="rgba(255,255,255,0.4)" textAnchor="middle">MAIL</text>

                      <rect x="16" y="25" width="24" height="14" rx="0" fill="rgba(255,255,255,0.02)" stroke="#1A1C1E" strokeWidth="1" />
                    ...
                    <g style={{ animation: 'line-flicker-comm-4 2s infinite' }}>
                      <line x1="-16" y1="-28" x2="16" y2="-28" stroke="#1A1C1E" strokeWidth="1" strokeDasharray="2,2" />
                      <line x1="-31" y1="2" x2="31" y2="2" stroke="#1A1C1E" strokeWidth="1" strokeDasharray="2,2" />
                      <line x1="-16" y1="32" x2="16" y2="32" stroke="#1A1C1E" strokeWidth="1" strokeDasharray="2,2" />
                      <line x1="-28" y1="-21" x2="-43" y2="-5" stroke="#1A1C1E" strokeWidth="1" strokeDasharray="2,2" />
                      <line x1="28" y1="-21" x2="43" y2="-5" stroke="#1A1C1E" strokeWidth="1" strokeDasharray="2,2" />
                    </g>

                    <g transform="translate(0, 0)">
                      <circle cx="0" cy="0" r="10" fill="rgba(0,0,0,0.6)" stroke="#1A1C1E" strokeWidth="1" />
                      <line x1="-4" y1="-4" x2="4" y2="4" stroke="#1A1C1E" strokeWidth="1.5" />
                      <line x1="4" y1="-4" x2="-4" y2="4" stroke="#1A1C1E" strokeWidth="1.5" />
                    </g>
                  </g>
                </svg>
                    ...
                    {activeAgent === 0 && (
                      <>
                        <svg width="513" height="386" viewBox="0 0 513 386" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <line x1="37.2969" y1="74.8008" x2="475.297" y2="74.8008" stroke="#1A1C1E" />
                          ...
                          <g filter="url(#filter0_d_agent1)">
                            ...
                            <rect x="73.7969" y="135.801" width="355" height="128" rx="9.5" stroke="#1A1C1E" />
                          </g>
                          ...
                          <g filter="url(#filter1_d_agent1)">
                            ...
                            <rect x="73.7969" y="316.801" width="83" height="27" rx="5.5" stroke="#1A1C1E" shape-rendering="crispEdges" />
                          ...
                          <g filter="url(#filter2_d_agent1)">
                            ...
                            <rect x="207.797" y="316.801" width="83" height="27" rx="5.5" stroke="#1A1C1E" shape-rendering="crispEdges" />
                          ...
                          <g filter="url(#filter3_d_agent1)">
                            ...
                            <rect x="336.797" y="316.801" width="91" height="27" rx="5.5" stroke="#1A1C1E" shape-rendering="crispEdges" />
                          ...
                          <foreignObject x="335.997" y="263.001" width="181.6" height="127.6"><div style={{ backdropFilter: "blur(8.15px)", clipPath: "url(#bgblur_0_agent1_clip_path)", height: "100%", width: "100%" }}></div></foreignObject><g filter="url(#filter4_d_agent1)" data-figma-bg-blur-radius="16.3">
                            ...
                            <rect x="367.797" y="294.801" width="133" height="79" rx="9.5" stroke="#1A1C1E" shape-rendering="crispEdges" />
                          </g>
                          ...
                          <foreignObject x="-5.00312" y="-4.99922" width="181.6" height="127.6"><div style={{ backdropFilter: "blur(8.15px)", clipPath: "url(#bgblur_1_agent1_clip_path)", height: "100%", width: "100%" }}></div></foreignObject><g filter="url(#filter5_d_agent1)" data-figma-bg-blur-radius="16.3">
                            ...
                            <rect x="11.7969" y="11.8008" width="133" height="79" rx="9.5" stroke="#1A1C1E" shape-rendering="crispEdges" />
                          </g>
                    ...
                    {activeAgent === 1 && (
                      <>
                        <svg width="100%" height="100%" viewBox="0 0 513 386" fill="none" xmlns="http://www.w3.org/2000/svg">
                          {/* Base Terminal Box */}
                          <rect x="38.7969" y="23.8008" width="436" height="308" fill="#0A0B0E" stroke="#1A1C1E" strokeWidth="1"/>
                          
                          {/* Header */}
                          <line x1="38.7969" y1="53.8008" x2="474.7969" y2="53.8008" stroke="#1A1C1E" />
                          ...
                          <g filter="url(#drop_shadow_guard)">
                            <rect x="70" y="240" width="248" height="60" fill="#0A0B0E" stroke="#1A1C1E" />
                          ...
                          <defs>
                            ...
                            <pattern id="guard_grid_v2" width="20" height="20" patternUnits="userSpaceOnUse">
                              <path d="M 20 0 L 0 0 0 20" fill="none" stroke="#1A1C1E" strokeWidth="1" />
                      ...
                      <>
                        <svg width="100%" height="100%" viewBox="0 0 513 386" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <g filter="url(#filter1_d_agent3)">
                            ...
                            <rect x="73.7969" y="316.801" width="83" height="27" rx="5.5" stroke="#1A1C1E" shapeRendering="crispEdges" />
                          ...
                          <g filter="url(#filter2_d_agent3)">
                            ...
                            <rect x="207.797" y="316.801" width="83" height="27" rx="5.5" stroke="#1A1C1E" shapeRendering="crispEdges" />
                          ...
                          <g filter="url(#filter3_d_agent3)">
                            ...
                            <rect x="336.797" y="316.801" width="103" height="27" rx="5.5" stroke="#1A1C1E" shapeRendering="crispEdges" />
                          ...
                          <g className="float-badge-box" style={{ animationDelay: "0.8s" }}>
                            ...
                            <g filter="url(#filter4_d_agent3)">
                              ...
                              <rect x="367.797" y="294.801" width="133" height="79" rx="9.5" stroke="#1A1C1E" shapeRendering="crispEdges" />
                            </g>
                          ...
                          <g className="float-badge-box" style={{ animationDelay: "0.2s" }}>
                            ...
                            <g filter="url(#filter5_d_agent3)">
                              ...
                              <rect x="11.7969" y="11.8008" width="133" height="79" rx="9.5" stroke="#1A1C1E" shapeRendering="crispEdges" />
                            </g>
                          ...
                          <defs>
                            ...
                            <pattern id="emp_grid_agent3" width="20" height="20" patternUnits="userSpaceOnUse">
                              <path d="M 20 0 L 0 0 0 20" fill="none" stroke="#1A1C1E" strokeWidth="0.5" />
                            </pattern>
                      ...
                      <>
                        <svg width="100%" height="100%" viewBox="0 0 513 386" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <g style={{ clipPath: 'url(#card-screen-clip_agent4)' }}>
                            ...
                            <g>
                              <rect x="255" y="145" width="160" height="110" rx="6" fill="rgba(255,255,255,0.01)" stroke="#1A1C1E" strokeWidth="1" />
                      ...
                      <>
                        <svg width="100%" height="100%" viewBox="0 0 513 386" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <g style={{ clipPath: 'url(#card-screen-clip_agent6)' }}>
                            ...
                            <g>
                              <rect x="255" y="175" width="162" height="80" rx="6" fill="rgba(255,255,255,0.01)" stroke="#1A1C1E" strokeWidth="1" />
            ...
            <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', alignItems: 'center', flexWrap: 'wrap' }}>
                <a href="#" className="ent-btn-primary" style={{
                  ...
                  position: 'relative',
                  zIndex: 20
                }}>Request Communication Assessment <svg className="hover-arrow-svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path className="arrow-stem" d="M3 12h12" /><path className="arrow-head" d="m9 18 6-6-6-6"/></svg></a>
                <a href="#" className="ent-btn-secondary award-fade-up delay-btn" style={{
                  padding: '12px 24px',
                  fontSize: '0.95rem',
                  display: 'inline-flex',
                  transform: 'translateZ(0)',

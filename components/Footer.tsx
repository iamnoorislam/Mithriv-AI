...
export default function Footer() {
  ...
  return (
    <footer className="cinematic-footer">
        <div className="footer-watermark">MITHRIV</div>
        <div className="footer-container">
            <div className="footer-grid">
                <div className="footer-brand">
                    ...
                    <p>The definitive autonomous execution engine for physical and digital infrastructure. Build the future with confidence.</p>
                </div>
